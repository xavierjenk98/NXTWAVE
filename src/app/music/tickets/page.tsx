...
import eventsData from "@/content/events-music.json";

export const metadata = { title: "Music Tickets — NXTWAVE LIVE" };
...
function DropAlertsInline() {
  return (
    <span className="shrink-0 border border-purple-500/50 text-purple-400 font-black uppercase tracking-widest text-sm px-6 py-3 rounded-lg text-center cursor-default">
      Get Drop Alerts ↓
    </span>
  );
}

export default function MusicTicketsPage() {
    ...
    <div className="pt-24 pb-16 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-4 mb-12">
          {events.map((event) => (
            <div key={event.id} className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-xl border border-white/10 bg-white/5 p-6 hover:border-purple-500/30 transition-all">
